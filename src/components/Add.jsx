    ...
    <>
        <div id="addCommentContainer" className='bg-white rounded-lg p-4 md:p-6 md:h-[144px]'>
            <div id="formContainer">
                <form noValidate>
                    <div id="textContainer" className='mb-4 rounded-lg border border-lightGray pt-3 pl-6 md:ml-[56px] md:mr-[120px] md:mb-0'>
                        <textarea name="newComment" id="newComment" placeholder='Add a comment...' cols="30" rows="3" className='w-full placeholder:text-base placeholder:font-normal placeholder:text-grayishBlue'></textarea>
                    </div>
